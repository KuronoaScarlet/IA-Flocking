...
public class Flocka : MonoBehaviour
{
	...
	private List<Flocka> cohesionNeighbours = new List<Flocka>();
	private List<Flocka> avoidanceNeighbours = new List<Flocka>();
	private List<Flocka> aligementNeighbours = new List<Flocka>();
	private Flockamanagera assignedFlock;
	...
	public void AssignFlock(Flockamanagera flock)
	{
		assignedFlock = flock;
	}
